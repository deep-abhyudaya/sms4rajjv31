...
const LessonForm = ({
  ...
  useEffect(() => {
    if (state.success) {
      ...
      setOpen(false);
      // Wait a tiny bit for the state to propagate before refreshing the route
      setTimeout(() => {
        router.refresh();
      }, 100);
    }
  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      ...
      <button type="submit" className="bg-foreground text-background p-2.5 rounded-md font-medium hover:opacity-90">
