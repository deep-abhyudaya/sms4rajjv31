    ...
    >
      <td className="flex items-center gap-4 p-4">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-xs text-muted-foreground text-muted-foreground">{item.class.name}</p>
        </div>
      </td>
      ...
      <td>
        <div className="flex items-center gap-2">
          <Link href={`/list/students/${item.id}`}>
            <button className="w-7 h-7 flex items-center justify-center rounded-full bg-foreground hover:bg-foreground/90 transition-colors text-background">
              <Eye size={14} strokeWidth={2} />
            </button>
          </Link>
          {role === "admin" && (
            // <button className="w-7 h-7 flex items-center justify-center rounded-full bg-sky-600 hover:bg-sky-500 transition-colors">
